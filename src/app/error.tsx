  ...
  return (
    <div className="min-h-screen bg-[#0B0B1A] flex flex-col items-center justify-center text-white px-6">
      <div className="relative flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 blur-[100px] rounded-full pointer-events-none ${isForbidden ? 'bg-orange-500/20' : 'bg-red-500/20'}`}
        />

        <div className="mb-6 relative">
          <div
            className={`w-20 h-20 rounded-2xl flex items-center justify-center mx-auto ${isForbidden ? 'bg-orange-500/10 text-orange-400 border border-orange-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`}
          >
            {isForbidden ? (
